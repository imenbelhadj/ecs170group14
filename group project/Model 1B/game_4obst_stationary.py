...
class SnakeGameAI:
    ...
    def place_obstacles(self):
        ...
        if self.obstacle1 in self.snake:
            self.place_obstacles()
        if self.obstacle1 == self.food:
            self.place_obstacles()
        if self.obstacle2 in self.snake:
            self.place_obstacles()
        if self.obstacle2 == self.food:
            self.place_obstacles()
        if self.obstacle3 in self.snake: 
            self.place_obstacles()        
        if self.obstacle3 == self.food:
            self.place_obstacles()
        if self.obstacle4 == self.snake:
            self.place_obstacles()
        if self.obstacle4 == self.food:
            self.place_obstacles()
