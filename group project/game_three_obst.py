...
class SnakeGameAI:
    ...
    def place_obstacles(self):
        ...
        if self.obstacle3 in self.snake or self.obstacle3 == self.food:
            self.place_obstacles()        
        if self.obstacle1 == self.obstacle2 or self.obstacle1 == self.obstacle3 or self.obstacle2 == self.obstacle3:
            self.place_obstacles()
    ...
    def play_step(self, action):
        ...
        if self.head == self.obstacle1 or self.head == self.obstacle2 or self.head == self.obstacle3:
            game_over = True
            reward = -10
            return reward, game_over, self.score
    ...
    def is_collision(self, pt=None):
        ...
        #hits obstacle
        if pt in self.obstacle1 or pt in self.obstacle2 or pt in self.obstacle3:
            return True
