...
def play_itself(agent, n_games=10):
    ...
    for i in range(n_games):
        ...
        while True:
            ...
            reward, done, score, special_elements_collected = game.play_step(final_move)
            if done:
                scores.append(score)
                break
    return scores
...
def train():
    ...
    while agent.n_games < 200:  # Train for 200 games
        ...
        reward, done, score, specials_collected = game.play_step(final_move)

        total_specials_collected += specials_collected
        ...
        if done:
            ...
            # total_specials_collected += game.special_elements_collected_episode  # Accumulate specials collected per episode
    ...
    # Calculate average reward per episode after training
    print("Average Reward per Episode after Training:", total_score / agent.n_games)

    average_specials_collected = total_specials_collected / agent.n_games
    print("Average Specials Collected per Episode after Training:", average_specials_collected)
